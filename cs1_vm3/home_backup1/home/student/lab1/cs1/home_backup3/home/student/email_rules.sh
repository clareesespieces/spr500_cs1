...
#iptables -A INPUT -p tcp --sport 25 -j ACCEPT #email rule to compromise for the port inconsistencies
iptables -A INPUT -p tcp --dport 25 -j ACCEPT #email rule to compromise for the port inconsistencies 
